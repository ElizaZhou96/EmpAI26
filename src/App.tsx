  ...
  <React.Fragment>
    ...
    <div className="min-h-screen bg-[#f4eff8]">
      ...
      <section id="about" className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#77428D] mb-6 text-center">About the Workshop</h2>
          ...
          <h3 className="text-xl font-semibold text-[#77428D] mb-2">Topic of Interest</h3>
            <p className="text-gray-600 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ul className="text-gray-600 mb-4 list-disc list-inside space-y-2">
				  ...
				  <li>Camera Ready Submission:{" "}<span className="font-bold"> April 21, 2026 (<span className="text-red-600 font-extrabold bg-red-100 px-1 rounded"> 11:59 pm JST </span>, aligned with FG 2026 main conference) </span></li>
				  	{/* (<a
				      href="https://time.is/Anywhere_on_Earth"
				      target="_blank"
				      rel="noopener noreferrer"
